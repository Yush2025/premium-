...
{Z1}│  {rb5}      ██║░░░░░██║░░██║███████╗██║░╚═╝░██║██║╚██████╔╝██║░╚═╝░██║{Z1}        │
{Z1}│  {rb6}      ╚═╝░░░░░╚═╝░░╚═╝╚══════╝╚═╝░░░░░╚═╝╚═╝░╚═════╝░╚═╝░░░░░╚═╝{Z1}        │
{Z1}│                                {green} NOT FOR {hotpink}FREE                    {Z1}         │
{Z1}│   {Z1}               ╭─────────────────────────────────╮                {Z1}     │
{Z1}╰───────────────────────────{BG}DEVELOPER SYTHE{RW}{Z1} ───────────────────────────────╯

{Z1}    ╭📁 
{Z1}    │           {Z1}╭─────────────╮
{Z1}    │─────{BG}AUTHOR{RW}{Z1}│ {gh6}YUSH HUELIN {Z1}│
{Z1}    │           {Z1}╰─────────────╯
{Z1}    │           {Z1}╭─────────────╮            ╭─────────────╮
{Z1}    │─────{BG}TOOLS {RW}{Z1}│   {gh6}PREMIUM   {Z1}│─────{BG}VERSION{RW}{Z1}│   {gh6}  7.6   {Z1}  │
{Z1}    │          {Z1} ╰─────────────╯            ╰─────────────╯
{Z1}    ╭─────────────────────────────────────────────────────────────────╮
{Z1}    │  {BG}USES{RW}{white}    : {gh6}Fb Boosting tools    {BG}UPDATED DATE {RW}{white}: {gh6}Apr 24. 2025  {Z1}   │
{Z1}    │  {BG}NETWORK{RW}{white} : {gh6}All network          {BG}COUNTRY{RW}{white}      : {gh6}Philippines     {Z1} │
{Z1}    │  {BG}STATUS{RW}{white}  : {gh6}Online               {BG}TOOLS{RW}{white} : {gh6}Paided                 {Z1} │
{Z1}    ╰─────────────────────────────────────────────────────────────────╯""")
...
def main():
    ...
    total_account_rpw, total_pages_rpw = count_tokens(rpwaccounts,rpwpages)
    jovan()
    print(f"""           {Z1} ༺═─────────────{BG}ACCOUNT OVERVIEWS{RW}{Z1}─────────────────═༻ 
                            {Z1}𝗙𝗥𝗔 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 {yellow}: {green}{total_accounts}
                            {Z1}𝗙𝗥𝗔 𝗣𝗔𝗚𝗘𝗦  {yellow} : {green}{total_pages}
                            {Z1}𝗥𝗣𝗪 𝗔𝗖𝗖𝗢𝗨𝗡𝗧{yellow} : {green}{ total_account_rpw}
                            {Z1}𝗥𝗣𝗪 𝗣𝗔𝗚𝗘𝗦 {yellow}  : {green}{total_pages_rpw} """)
                            
    print(f"{Z1}╭──────────────────────────{BG} 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐎𝐕𝐄𝐑𝐕𝐈𝐄𝐖 {RW}{Z1}──────────────────────────────╮""")
    print(f"{Z1}│         {Q}〘 {lightblue}A/01{Q} 〙{Q5} ADD ACCOUNT                                       {Z1}    │")
    print(f"{Z1}│         {Q}〘 {lightblue}B/02{Q} 〙{Q5} ACCOUNT REMOVER                                   {Z1}    │") 
    print(f"{Z1}│         {Q}〘 {lightblue}C/03{Q} 〙{Q5} REMOVED DUPLICATE ACCOUNTS           {Z1}                 │")
    print(f"{Z1}│         {Q}〘 {lightblue}D/04{Q} 〙 {Q5}LIVE ACCOUNT CHECKER                        {Z1}          │")
    print(f"{Z1}│         {Q}〘 {lightblue}E/05{Q} 〙{Q5} VALIDATES LIVE ACCOUNT TOKEN            {Z1}              │")
    print(f"{Z1}│         {Q}〘 {lightblue}F/06{Q} 〙 {Q5}UPDATE TOOLS                                  {Z1}        │")
    print(f"{Z1}╰──────────────────────────────────────────────────────────────────────────╯ ")
    print(f"{Z1}╭──────────────────────{BG} 𝐓𝐎𝐎𝐋𝐒 𝐑𝐄𝐀𝐂𝐓𝐈𝐎𝐍 𝐒𝐄𝐑𝐕𝐈𝐂𝐄 {RW}{Z1}────────────────────────────╮")
    print(f"{Z1}│         {Q}〘 {lightblue}G/07{Q} 〙 {Q5}AUTOMATIC REACTION                                {Z1}    │")
    print(f"{Z1}│         {Q}〘 {lightblue}H/08{Q} 〙{Q5} AUTOMATIC REACTION REELS                        {Z1}      │") 
    print(f"{Z1}│         {Q}〘 {lightblue}I/09{Q} 〙{Q5} AUTOMATIC REACTION GROUP                            {Z1}  │")
    print(f"{Z1}│         {Q}〘 {lightblue}J/10{Q} 〙 {Q5}AUTOMATIC REACTION [ VIDEO OR PHOTO ]            {Z1}     │")
    print(f"{Z1}│         {Q}〘 {lightblue}K/11{Q} 〙{Q5} AUTOMATIC REACTION DP/POST                        {Z1}    │") 
    print(f"{Z1}│         {Q}〘 {lightblue}L/12{Q} 〙{Q5} AUTOMATIC REACTION POST ( W/CARE )              {Z1}      │")
    print(f"{Z1}╰──────────────────────────────────────────────────────────────────────────╯ ")
    print(f"{Z1}╭──────────────────────{BG} 𝐀𝐔𝐓𝐎𝐌𝐀𝐓𝐈𝐂 𝐒𝐇𝐀𝐑𝐄 𝐒𝐄𝐑𝐕𝐈𝐂𝐄 {RW}{Z1}───────────────────────────╮")
    print(f"{Z1}│         {Q}〘 {lightblue}M/13{Q} 〙 {Q5}AUTOMATIC SHARE BOT FAST SPEED              {Z1}          │")
    print(f"{Z1}│         {Q}〘 {lightblue}N/14{Q} 〙 {Q5}AUTOMATIC SHARE WITH NOTIFICATION            {Z1}         │") 
    print(f"{Z1}╰──────────────────────────────────────────────────────────────────────────╯ ")
    print(f"{Z1}╭──────────────────────{BG} 𝐅𝐎𝐋𝐋𝐎𝐖 & 𝐂𝐎𝐌𝐌𝐄𝐍𝐓 𝐒𝐄𝐑𝐕𝐈𝐂𝐄 {RW}{Z1}──────────────────────────╮")
    print(f"{Z1}│         {Q}〘 {lightblue}O/15{Q} 〙{Q5} AUTOMATIC FOLLOWERS                              {Z1}     │")
    print(f"{Z1}│         {Q}〘 {lightblue}P/16{Q} 〙{Q5} AUTOMATIC FOLLOW PAGE AND PROFILE      {Z1}               │") 
    print(f"{Z1}│         {Q}〘 {lightblue}Q/17{Q} 〙{Q5} AUTOMATIC CUSTOM COMMENT                        {Z1}      │")
    print(f"{Z1}│         {Q}〘 {lightblue}R/18{Q} 〙{Q5} AUTOMATIC COMMENT ON GOING LIVESTREAM     {Z1}            │")
    print(f"{Z1}╰───────┏──────────────────────────────────────────────────────────────────╯")
    choice = input(f" {Z1}       └──> {Q5}ENTER YOUR CHOICE {green}: ").strip()         
