...
def jovan():
    ...
    print(f"""
┌──────────────────────────────────────────────────────────────────────────┐
│  👑 Author : MIKAZUMI DIAZ                  💵 Tools : Paided            │
│  🗓️  Build Date : June 25              🍄 Premium Tools                   │
│  🚀 Version : 1.7.5                   🚥 Status : Active                 │
│  📂 Uses : Boosting                   📶 Connection : Wifi / Data        │
│                                                                          │
│        W E L C O M E  T O  H E N T A I  B O O S T I N G  T O O L S       │
└──────────────────────────────────────────────────────────────────────────┘""")
...
def main():
    ...
    print(f"                      """)
    print(f"""┌──────────────────────────────────────────────────────────────────────────┐
│   🗂️ Total of {green}FRA{white} ACCOUNT Stored  : {total_accounts}                                     │
│   🗂️ Total of {green}FRA {white}PAGE  Stored    : {total_pages}                                     │
│   🗂️ Total of {red}RPW {white}ACCOUNT Stored  : {total_account_rpw}                                     │
│   🗂️ Total of {red}RPW {white}PAGE Stored     : {total_pages_rpw}                                     │
│                                                                          │
│              {green}A C C O U N T  O V E R V I E W  S T A T U S                {white} │
└──────────────────────────────────────────────────────────────────────────┘""")
       
    print(f"{white}┌─────────────────────────────────────────────────────────────────────────┐")
    print(f"{white}│ {BG1}                          TOOLS MANAGEMENT                             {RW}{white} │")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│    Service                   Choice Number              Information     │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Add account                   {white}[ {yellow}01/A {white}]              {KL}Account Extractor  {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Account Remover              {white} [ {yellow}02/B{white} ]         {KL}Storage Account Remover {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Dulpicate Remover             {white}[ {yellow}03/C {white}]     {KL}  Duplicate Account Remover {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│ {Q} Live Account Checker        {white}  [ {yellow}04/D{white} ]              {KL} Account Checker   {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Live Token                 {white}   [ {yellow}05/E {white}]            {KL} Validation Checker  {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}┌─────────────────────────────────────────────────────────────────────────┐")
    print(f"{white}│ {BG1}                          REACTION SERVICES                             {RW}{white}│")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│    Service                   Choice Number              Information     │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Reaction V1                 {white}  [ {yellow}06/F{white} ]              {KL} Page Or Account   {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Reaction Reels             {white}   [ {yellow}07/G {white}]             {KL}  Page Or Account   {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Reaction Group Post           {white}[ {yellow}08/H {white}]             {KL}  Page Or Account   {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Reaction Video/Photo        {white}  [ {yellow}09/I {white}]             {KL}  Page Or Account   {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Reaction Dp/Normal Post  {white}     [ {yellow}10/J {white}]             {KL}  Page Or Account   {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Reaction V2                  {white} [ {yellow}11/K{white} ]           {KL}    Page Or Account  {white} │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}┌─────────────────────────────────────────────────────────────────────────┐")
    print(f"{white}│ {BG1}                             SHARE SERVICE                             {RW}{white} │")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│    Service                   Choice Number              Information     │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Auto Share V1               {white} [ {yellow}12/L {white}]                {KL}  Bot/Monitizable {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Auto Share V2            {white}    [ {yellow}13/M {white}]               {KL}Active/Monitizable{white} │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}┌─────────────────────────────────────────────────────────────────────────┐")
    print(f"{white}│ {BG1}                          FOLLOW AND COMMENTS                          {RW}{white} │")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│    Service                   Choice Number              Information     │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Followers V1               {white}  [ {yellow}14/N {white}]                {KL} Page Or Account {white} │ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Followers Profile/Page      {white} [ {yellow}15/O {white}]                 {KL}Page Or Account  {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Custom Comments             {white} [ {yellow}16/P {white}]                {KL} Page Or Account  {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    print(f"{white}│  {Q}Comments On Going Live       {white}[ {yellow}17/Q{white} ]             {KL}    Page Or Account  {white}│ ")
    print(f"{white}└─────────────────────────────────────────────────────────────────────────┘")
    choice = input(f"│ {Q}ENTER YOUR CHOICE {yellow}──────────{white}➤   ").strip() 
#C:\Users\Dont touch my pc\Desktop\OPENSOURCE\sy.py
    ...
    if choice == '22' or choice == 'V':
        react()
    if choice == '23' or choice == 'X':
        bitz()
    if choice == '24' or choice == 'Y':
        mainzsa()
