...
def main():
    ...
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {Z1}7/G {white}Reaction V1        {blue}       ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}8/H {white}Reaction Reels         {blue}   ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}9/I {white}Reaction Group Post       {blue}◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}10/J {white}Reaction Video/Photo     {blue}◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}11/K {white}Reaction Dp/Normal Post {blue} ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}12/L {white}Reaction V2        {blue}      ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}                {BG1} 𝐀𝐔𝐓𝐎𝐌𝐀𝐓𝐈𝐂 𝐒𝐇𝐀𝐑𝐄  𝐒𝐄𝐑𝐕𝐈𝐂𝐄𝐒 {RW}{BG}                  {RW} """)
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {Z1}13/M {white}Share V1 [ bot ]         {blue}◆{Z1} Fast Speed  {RW}{BG}            {RW} ")
    print(f"       {BG}   {Q}○ {Z1}14/N {white}Share V2 [ monitizable ] {blue}◆{Z1} Fast Speed  {RW}{BG}            {RW} ")
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}              {BG1} 𝐅𝐎𝐋𝐋𝐎𝐖 𝐀𝐍𝐃 𝐂𝐎𝐌𝐌𝐄𝐍𝐓  𝐒𝐄𝐑𝐕𝐈𝐂𝐄𝐒 {RW}{BG}                 {RW} """)
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {Z1}15/O {white}Followers V1       {blue}      ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}16/P {white}Followers Page/Profile   {blue}◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}17/Q {white}Custom Comments   {blue}       ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {Z1}18/R {white}Comments On going live {blue}  ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}              {BG1} 𝐎𝐖𝐍𝐄𝐑 𝐎𝐑 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 {RW}{BG}                   {RW} """)
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {Z1}19/S {white}Contact Owner       {blue}     ◆{Z1} Facebook {RW}{BG}               {RW} ")
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG} {BG1}              𝐂𝐎𝐎𝐊𝐈𝐄𝐒 𝐀𝐍𝐃 𝐓𝐎𝐊𝐄𝐍 𝐒𝐄𝐑𝐕𝐈𝐂𝐄𝐒 {RW}             {BG}      {RW} """)
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {Z1}20/T {white}Automatic Share via Token {blue}◆{Z1} Account {RW}{BG}               {RW} ")
    print(f"       {BG}   {Q}○ {Z1}21/U {white}Cookies and Token Getter{blue}  ◆{Z1} Account {RW}{BG}               {RW} ")
    print(f"       {BG}   {Q}○ {Z1}22/V {white}Reaction V1              {blue} ◆{Z1} Page or Account {RW}{BG}       {RW} ")
    print(f"       {BG}                                                             {RW} ")
